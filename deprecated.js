  ...
  return (
    <View style={styles.fill}>
      ...
      <View style={{ flex: 1, zIndex: 10, backgroundColor: 'transparent' }}>
        ...
        >
          <Tab style={{ backgroundColor: 'transparent' }} heading='Personal'>
            <Animated.ScrollView
          ...
          <Tab style={{ backgroundColor: 'transparent' }} heading='Career'>
            <Animated.ScrollView
              showsVerticalScrollIndicator={false}
          ...
          <Tab style={{ backgroundColor: 'transparent' }} heading='Albums'>
            <Animated.ScrollView
              showsVerticalScrollIndicator={false}
